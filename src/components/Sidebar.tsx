...
import { SidebarItems } from "../shared-types";
...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="h-full bg-gray-800 bg-opacity-50 backdrop-blur-md4 flex flex-col border-r border-gray-700">
        <motion.button
        ...
        <nav className="mt-8 flex-grow">
          {SIDEBAR_ITEMS.map((item: SidebarItems) => (
